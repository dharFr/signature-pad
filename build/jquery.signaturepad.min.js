...
"&gt;").replace(/</g,"&lt;"));b(a.typed,c).width()>h.width;)d=b(a.typed,c).css("font-size").replace(/px/,""),b(a.typed,c).css("font-size",d-1+"px")}function F(d,a){b("p."+a.errorClass,d).remove();d.removeClass(a.errorClass);b("input, label",d).removeClass(a.errorClass)}function G(a,c,f){a.nameInvalid&&(c.prepend(['<p class="',f.errorClass,'">',f.errorMessage,"</p>"].join("")),b(f.name,c).focus(),b(f.name,c).addClass(f.errorClass),b("label[for="+b(f.name).attr("id")+"]",c).addClass(f.errorClass));
a.drawInvalid&&c.prepend(['<p class="',f.errorClass,'">',f.errorMessageDraw,"</p>"].join(""))}function v(){a.onOutputChange&&"function"===typeof a.onOutputChange&&C!==i.length&&(C=i.length,a.onOutputChange(i))}function D(){var d=!0,e={drawInvalid:!1,nameInvalid:!1},f=[c,a],j=[e,c,a];a.onBeforeValidate&&"function"===typeof a.onBeforeValidate?a.onBeforeValidate.apply(o,f):F.apply(o,f);a.drawOnly&&1>i.length&&(e.drawInvalid=!0,d=!1);""===b(a.name,c).val()&&(e.nameInvalid=!0,d=!1);a.onFormError&&"function"===
typeof a.onFormError?a.onFormError.apply(o,j):G.apply(o,j);return d}function E(d,b,c){for(var e in d)"object"===typeof d[e]&&(b.beginPath(),b.moveTo(d[e].mx,d[e].my),b.lineTo(d[e].lx,d[e].ly),b.lineCap=a.penCap,b.stroke(),b.closePath(),c&&i.push({lx:d[e].lx,ly:d[e].ly,mx:d[e].mx,my:d[e].my}))}function H(){if(4.1>parseFloat((/CPU.+OS ([0-9_]{3}).*AppleWebkit.*Mobile/i.exec(navigator.userAgent)||[0,"4_2"])[1].replace("_",".")))b.fn.Oldoffset=b.fn.offset,b.fn.offset=function(){var a=b(this).Oldoffset();
a.top-=window.scrollY;a.left-=window.scrollX;return a};b(a.typed,c).bind("selectstart.signaturepad",function(a){return b(a.target).is(":input")});g.bind("selectstart.signaturepad",function(a){return b(a.target).is(":input")});!h.getContext&&FlashCanvas&&FlashCanvas.initElement(h);h.getContext&&(e=h.getContext("2d"),b(a.sig,c).show(),a.displayOnly||(a.drawOnly||(b(a.name,c).bind("keyup.signaturepad",function(){B(b(this).val())}),b(a.name,c).bind("blur.signaturepad",function(){B(b(this).val())}),b(a.drawIt,
c).bind("click.signaturepad",function(a){a.preventDefault();x()})),a.drawOnly||"drawIt"===a.defaultAction?x():A(),a.validateFields&&(b(r).is("form")?b(r).bind("submit.signaturepad",function(){return D()}):b(r).parents("form").bind("submit.signaturepad",function(){return D()})),b(a.sigNav,c).show()))}var o=this,a=b.extend({},b.fn.signaturePad.defaults,p),c=b(r),g=b(a.canvas,c),h=g.get(0),e=null;l=k=null;var i=[],C=0,n=!1,q=!1,w=!1;b.extend(o,{init:function(){H()},regenerate:function(d){o.clearCanvas();
b(a.typed,c).hide();"string"===typeof d&&(d=JSON.parse(d));E(d,e,!0);0<b(a.output,c).length&&(b(a.output,c).val(JSON.stringify(i)),v())},clearCanvas:function(){t()},getSignature:function(){return i},getSignatureString:function(){return JSON.stringify(i)},getSignatureImage:function(){var b=document.createElement("canvas"),c=null,c=null;b.style.position="absolute";b.style.top="-999em";b.width=h.width;b.height=h.height;document.body.appendChild(b);!b.getContext&&FlashCanvas&&FlashCanvas.initElement(b);
c=b.getContext("2d");c.fillStyle=a.bgColour;c.fillRect(0,0,h.width,h.height);c.lineWidth=a.penWidth;c.strokeStyle=a.penColour;E(i,c);c=b.toDataURL.apply(b,arguments);document.body.removeChild(b);return c}})}b.fn.signaturePad=function(b){var p=null;this.each(function(){p=new u(this,b);p.init()});return p};b.fn.signaturePad.defaults={defaultAction:"typeIt",displayOnly:!1,drawOnly:!1,canvas:"canvas",sig:".sig",sigNav:".sigNav",bgColour:"#ffffff",penColour:"#145394",penWidth:2,penCap:"round",lineColour:"#ccc",
lineWidth:2,lineMargin:5,lineTop:35,name:".name",typed:".typed",clear:".clearButton",typeIt:".typeIt a",drawIt:".drawIt a",typeItDesc:".typeItDesc",drawItDesc:".drawItDesc",output:".output",currentClass:"current",validateFields:!0,errorClass:"error",errorMessage:"Please enter your name",errorMessageDraw:"Please sign the document",onBeforeValidate:null,onFormError:null,onOutputChange:null}})(jQuery);
